...
ROOT_DIR = environ.Path(__file__) - 3  # (kaimun/config/settings/base.py - 3 = kaimun/)
APPS_DIR = ROOT_DIR.path('kaimun')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///kaimun'),
}
...
LOCAL_APPS = [
    'kaimun.users.apps.UsersAppConfig',
    'country',
...
MIGRATION_MODULES = {
    'sites': 'kaimun.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Bernard Parah""", 'barjebernard@gmail.com'),
]
